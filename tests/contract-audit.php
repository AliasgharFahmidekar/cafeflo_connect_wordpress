...
$checks = array(
    ...
    'Order payload carries both Woo and FloCafe IDs' => strpos( $source['includes/class-cafeflo-orders.php'], "'product_id' => (int) $product->get_id()" ) !== false && strpos( $source['includes/class-cafeflo-orders.php'], "'flocafe_product_id' => $flocafe_id" ) !== false,
